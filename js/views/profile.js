...
function renderAccount(body) {
    ...
    ]), sectionHead('Your data'), el('div', { class: 'row-actions' }, [exportButton]), sectionHead('App'), el('p', { class: 'muted', text: `Version ${APP_VERSION} · API ${api.apiBase()}` }), el('div', { class: 'row-actions' }, [refreshApp, signOut]));
}
